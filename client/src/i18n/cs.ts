...
export const cs: Translations = {
  ...
  product: {
    ...
    inStockFilter: 'Skladem',
    productType: 'Typ produktu',
    newProducts: 'Novinky',
    onSale: 'V akci',
    bazaar: 'Bazar',
    clearFilters: 'Vymazat filtry',
    sortNewest: 'Od nejnovějšího',
    sortOldest: 'Od nejstaršího',
  ...
  account: {
    ...
    welcomeDesc: 'Zde najdete přehled vašich objednávek a nastavení účtu.',
    orders: 'Objednávky',
    ...
    processingStatus: 'Zpracovávané',
    shippedStatus: 'Odeslané',
    deliveredStatus: 'Doručené',
    cancelledStatus: 'Zrušené',
    noOrdersFound: 'Žádné objednávky',
    noOrdersFilterDesc: 'Nenašly se žádné objednávky odpovídající vašemu filtru.',
    noOrdersDesc: 'Zatím jste nevytvořili žádnou objednávku.',
    startShopping: 'Začít nakupovat',
    created: 'Vytvořena',
    item: 'položka',
    items: 'položky',
